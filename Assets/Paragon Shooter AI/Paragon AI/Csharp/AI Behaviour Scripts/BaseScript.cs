...
public class BaseScript : MonoBehaviour 
{
	...
	public enum AIBehaviour{
        GoToMoveTarget = 0, Cover = 1, Search = 2, Dodging = 3, Patrolling = 4, Wander = 5, UseDynamicObject = 6, InvestigateSound = 7, Custom = 8, MoveToTransform = 9, RunFromGrenade = 10, Skirmish
	}
	...
	public CustomAIBehaviour GetNewBehaviour(AIBehaviour t)
	{
		...
		switch(t)
			{					
                ...
                case AIBehaviour.Skirmish: bToReturn = (ParagonAI.CustomAIBehaviour)gameObject.AddComponent(typeof(ParagonAI.Skirmish)); break; 
			}
		bToReturn.Initiate();	
		return bToReturn;
	}
